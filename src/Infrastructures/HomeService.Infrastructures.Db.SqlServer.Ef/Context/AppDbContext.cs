...
namespace HomeService.Infrastructures.Db.SqlServer.Ef.Context;
...
//=> optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=HomeServiceDB;Trusted_Connection=True;TrustServerCertificate=True;");
